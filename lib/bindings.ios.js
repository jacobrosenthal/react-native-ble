...
nobleBindings.init = function(native) {
  ...
  if(native) {
    ...
    console.log(require('react-native').NativeModules.hasOwnProperty('BLEManager'));
    this.RNBLE = require('react-native').NativeModules.BLEManager;
    this.DeviceEventEmitter = require('react-native').DeviceEventEmitter;
  }

  this.DeviceEventEmitter.addListener('connect', this.onConnect.bind(this));
  this.DeviceEventEmitter.addListener('disconnect', this.onDisconnect.bind(this));
  this.DeviceEventEmitter.addListener('discover', this.onDiscover.bind(this));
  this.DeviceEventEmitter.addListener('rssiUpdate', this.onRssiUpdate.bind(this));
  this.DeviceEventEmitter.addListener('servicesDiscover', this.onServicesDiscover.bind(this));
  this.DeviceEventEmitter.addListener('includedServicesDiscover', this.onIncludedServicesDiscover.bind(this));
  this.DeviceEventEmitter.addListener('characteristicsDiscover', this.onCharacteristicsDiscover.bind(this));
  this.DeviceEventEmitter.addListener('descriptorsDiscover', this.onDescriptorsDiscover.bind(this));
  this.DeviceEventEmitter.addListener('stateChange', this.onStateChange.bind(this));
  this.DeviceEventEmitter.addListener('data', this.onData.bind(this));
  this.DeviceEventEmitter.addListener('write', this.onWrite.bind(this));
  this.DeviceEventEmitter.addListener('notify', this.onNotify.bind(this));
  this.DeviceEventEmitter.addListener('valueUpdate', this.onValueUpdate.bind(this));
  this.DeviceEventEmitter.addListener('valueWrite', this.onValueWrite.bind(this));
};
